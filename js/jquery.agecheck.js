...
(function ($) {
  $.ageCheck = function (options) {
    const settings = $.extend({
      ...
      copy: 'Este sitio web requiere que verifiques tu edad: ',
      success: null,
      successMsg: {
        header: 'Correcto!',
        body: 'Serás reedireccionado a la página correspondiente...'
      },
      underAgeMsg: 'Sorry, you are not old enough to view this site...',
      underAge: null,
      errorMsg: {
        invalidDay: 'Dia invalido o en blanco',
        invalidYear: 'Año invalido o en blanco'
      },
    ...
    const _this = {
      ...
      buildHtml() {
        ...
        const months = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septimbre', 'Octubre', 'Novimbre', 'Dicimbre'];
        let html = '';
